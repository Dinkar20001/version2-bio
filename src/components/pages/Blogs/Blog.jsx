        ...
        <div className="max-w-screen-xl mx-auto p-3 flex flex-col md:flex-row">
          ...
          <div className="p-3 w-full md:w-8/12">
            ...
            <div className="mt-5 flex rounded-md bg-gray-100 p-4 text-[13px] gap-2">
              <span>
                <CgDanger className="text-orange-400 w-6 h-6" />
              </span>
              <p>
                <b>
            ...
            <h2 className="text-3xl mt-5 text-red-500 font-bold">
            ...
            <div className="text-[13px]">
              <h2 className="text-2xl mt-5 font-semibold">Figure 2. The role of TDP-43 in neurodegeneration of motor neurons</h2>
             <img src="https://www.peptidesciences.com/media/wysiwyg/Role_of_TDP-43_in_Neurodegeneration_of_Motor_Neurons.webp" alt="banner" width={620} height={620}/>
             <p>Buntanetap has been demonstrated to be a multitargeted therapy capable of decreasing neurotoxic proteins involved in the development and progression of AD by reducing the levels of amyloid beta, improving neuroplasticity, and reducing neuroinflammatory species. Moreover, this novel therapy can also decrease PD-related proteins like alpha-synuclein and TDP-43, which have been demonstrated to have a role in the degeneration of motor neurons, thus causing the progression of neurodegenerative disorders like PD. In general terms, Buntanetap promotes the recovery of cognition, increases proliferation, improves neuronal plasticity, and significantly reduces neuroinflammation, thus slowing down the progression of PD and AD.[2,3,5]</p>

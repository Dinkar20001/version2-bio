            ...
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-7 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  <div className="mb-8 flex w-full h-96 rounded-2xl">
                    {/* <div class="overflow-hidden rounded-lg lg:col-span-2 h-96 "> */}

                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4647.875525398846!2d73.01794190534791!3d19.11014369118266!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c0c9173e407f%3A0x41da48a5d5a3576c!2sMillennium%20Business%20Park!5e1!3m2!1sen!2sin!4v1716985420510!5m2!1sen!2sin"
                      width={600}
                      height={450}
                      style={{ border: 0 }}
                      allowFullScreen
                ...
                <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                  <form>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full rounded border border-primary bg-orange-400 text-white p-3 transition hover:bg-opacity-90"
                      >
                        Submit
                      </button>
                    </div>

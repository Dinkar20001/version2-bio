      ...
      <section>
        <div className="max-w-screen-xl mx-auto p-3 flex flex-col md:flex-row">
          ...
          <div className="p-3 w-full md:w-8/12">
            <h2 className="text-3xl font-semibold">Indian Made Peptides</h2>
            ...
            <div className="flex flex-col gap-10 mt-7">
              <div>
                ...
                <h2 className="text-2xl mt-3 -mb-5">The Importance of Peptides Made in the INDIA</h2>
              </div>
              ...
              <div className="text-sm">
                <div className="flex flex-col md:flex-row">
                  ...
                  <img
                    width={175}
                    src="https://www.peptidesciences.com/peptide-information/wp-content/uploads/2016/07/USA-Made-Peptides-1-251x300.jpg"
                    alt="peptide img"
                  />
                </div>

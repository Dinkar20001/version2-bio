          ...
          <div className="p-3 w-full md:w-8/12">
            ...
            <div className="flex flex-col gap-10 mt-7">
              ...
              <div className="text-sm">
                <div className="flex flex-col">
                  ...
                  <img
                    width={355}
                    src="https://www.peptidesciences.com/peptide-information/wp-content/uploads/2016/05/peptide-bond-formation.gif"
                    alt="peptide img"
                  />
                </div>
            ...
            <div className="text-sm">
              ...
              <div className="flex flex-col md:flex-row">
                  ...
                  <img
                    width={375}
                    src="https://www.peptidesciences.com/peptide-information/wp-content/uploads/2016/05/Amino-Acid-and-Peptide-Bonds-300x171.jpg"
                    alt="peptide img"
                  />
                </div>

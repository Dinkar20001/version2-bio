        ...
        <div className="max-w-screen-xl mx-auto p-3 flex flex-col md:flex-row">
          ...
          <div className="p-3 w-full md:w-8/12">
            ...
            <div className="flex flex-col gap-10 mt-7">
              ...
              <div className="text-sm">
                <div className="flex flex-col md:flex-row">
                  ...
                  <img
                    width={175}
                    src="https://www.peptidesciences.com/peptide-information/wp-content/uploads/2016/05/Peptides.jpg"
                    alt="peptide img"
                  />
                </div>
            ...
            <div className="text-sm">
              ...
              <img className="my-5"
                width={300}
                src="https://www.peptidesciences.com/peptide-information/wp-content/uploads/2016/05/Peptide-Formation-300x70.png"
                alt="peptide img"
              />
